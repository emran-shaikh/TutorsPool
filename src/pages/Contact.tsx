        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/subjects" className="text-gray-700 hover:text-[#2c2e71] font-medium transition-colors">Subjects</Link>
              <Link to="/about" className="text-gray-700 hover:text-[#2c2e71] font-medium transition-colors">About</Link>
              <Link to="/contact" className="text-[#2c2e71] font-medium">Contact</Link>
            </div>
            ...
            <div className="flex items-center space-x-4">
              {user ? (
                <div className="flex items-center space-x-2">
                  ...
                  <Link to={getDashboardUrl()} className="btn-gradient-primary px-4 py-2 rounded-lg">
                    Dashboard
                  </Link>
                </div>
              ) : (
                <>
                  ...
                  <Link to="/signup" className="btn-gradient-primary px-6 py-2 rounded-lg">Get Started</Link>
                </>
              )}
            </div>
          </div>
